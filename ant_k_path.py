...
class Settings(object):#设置类
    ...
    STATIONS_ROUTE_TIME = {'ac':13,'ca':13,'cd':12,'dc':12,'de':10,'ed':10,'ef':2,'fe':2,'fg':6,'gf':6,'gh':5,'hg':5,
                   'di':9,'id':9,'ij':4,'ji':4,'jk':7,'kj':7,'kl':2,'lk':2,'lm':6,'ml':6,'mf':4,'fm':4,'fn':4,'nf':4,'nd':7,'dn':7,
                   'do':5,'od':5,'op':12,'po':12,'pq':7,'qp':7,'qr':6,'rq':6,'rs':13,'sr':13,'sj':6,'js':6,
                    'bt':23,'tb':23,'tn':6,'nt':6,'ne':3,'en':3,'ev':6,'ve':6,'vk':5,'kv':5,'ku':13,'uk':13}#各站点间耗时

    ########修OD结构,必须填写完整的OD################################
    O_D = {'ac':1480,'ad':2432,'ae':1704,'af':816,'ag':928,'ah':472,'ai':968,'aj':848,'ak':1328,'al':1456,'am':512,'an':272,'ao':808,'ap':744,'aq':512,'ar':536,'as':424,'ab':576,'at':1696,'av':664,'au':432,
         'ca':1056,'cd':1320,'ce':1432,'cf':896,'cg':1040,'ch':672,'ci':1488,'cj':1608,'ck':1904,'cl':1040,'cm':760,'cn':848,'co':864,'cp':1072,'cq':752,'cr':960,'cs':680,'cb':184,'ct':1104,'cv':1704,'cu':1080,
         'da':1392,'dc':1344,'de':832,'df':2520,'dg':2432,'dh':1712,'di':2136,'dj':2352,'dk':2824,'dl':1976,'dm':1278,'dn':960,'do':1128,'dp':1784,'dq':1656,'dr':1888,'ds':1696,'db':1104,'dt':2144,'dv':2432,'du':2208,
         'ea':2144,'ec':2920,'ed':984,'ef':608,'eg':1136,'eh':712,'ei':808,'ej':1088,'ek':1624,'el':1872,'em':1384,'en':312,'eo':968,'ep':1048,'eq':832,'er':872,'es':1040,'eb':2496,'et':3088,'ev':1232,'eu':3208,
         'fa':472,'fc':920,'fd':2296,'fe':128,'fg':360,'fh':448,'fi':1144,'fj':1008,'fk':1928,'fl':816,'fm':360,'fn':448,'fo':992,'fp':816,'fq':224,'fr':344,'fs':464,'fb':1336,'ft':1544,'fv':984,'fu':1520,
         'ga':624,'gc':1008,'gd':1472,'ge':848,'gf':464,'gh':248,'gi':1744,'gj':840,'gk':1184,'gl':448,'gm':360,'gn':688,'go':1264,'gp':984,'gq':848,'gr':192,'gs':824,'gb':864,'gt':1552,'gv':1680,'gu':1008,
         'ha':752,'hc':1264,'hd':824,'he':1168,'hf':1080,'hg':408,'hi':1632,'hj':992,'hk':1736,'hl':1016,'hm':832,'hn':1312,'ho':992,'hp':544,'hq':672,'hr':560,'hs':864,'hb':672,'ht':1728,'hv':1288,'hu':1472,
         'ia':432,'ic':552,'id':784,'ie':1912,'if':1920,'ig':1272,'ih':448,'ij':328,'ik':1392,'il':544,'im':1296,'in':832,'io':1136,'ip':256,'iq':464,'ir':248,'is':544,'ib':288,'it':944,'iv':1248,'iu':1968,
         'ja':624,'jc':1472,'jd':1704,'je':1344,'jf':1448,'jg':1824,'jh':808,'ji':328,'jk':808,'jl':568,'jm':712,'jn':1232,'jo':1128,'jp':168,'jq':280,'jr':216,'js':512,'jb':808,'jt':944,'jv':1248,'ju':1792,
         'ka':904,'kc':3064,'kd':2848,'ke':944,'kf':2192,'kg':2408,'kh':1248,'ki':1880,'kj':2016,'kl':1264,'km':1312,'kn':2032,'ko':1368,'kp':2928,'kq':1704,'kr':1880,'ks':1840,'kb':912,'kt':1968,'kv':816,'ku':2024,
         'la':840,'lc':1488,'ld':2688,'le':1536,'lf':1160,'lg':992,'lh':1048,'li':680,'lj':184,'lk':904,'lm':448,'ln':696,'lo':720,'lp':1248,'lq':808,'lr':1008,'ls':848,'lb':992,'lt':2280,'lv':960,'lu':1680,
         'ma':536,'mc':1104,'md':2776,'me':992,'mf':800,'mg':1136,'mh':696,'mi':808,'mj':984,'mk':1472,'ml':960,'mn':1080,'mo':904,'mp':592,'mq':856,'mr':840,'ms':808,'mb':752,'mt':1496,'mv':1000,'mu':1024,
         'na':432,'nc':1312,'nd':1704,'ne':328,'nf':272,'ng':1128,'nh':1072,'ni':1424,'nj':1312,'nk':2608,'nl':1424,'nm':1712,'no':1072,'np':808,'nq':992,'nr':504,'ns':784,'nb':1472,'nt':992,'nv':1440,'nu':1728,
         'oa':816,'oc':904,'od':1432,'oe':1264,'of':1136,'og':1048,'oh':368,'oi':1232,'oj':1088,'ok':1304,'ol':1968,'om':1112,'on':1040,'op':216,'oq':504,'or':408,'os':456,'ob':1336,'ot':2008,'ov':1280,'ou':992,
         'pa':592,'pc':368,'pd':1128,'pe':968,'pf':1832,'pg':808,'ph':752,'pi':1344,'pj':1704,'pk':1312,'pl':1176,'pm':304,'pn':320,'po':456,'pq':272,'pr':544,'ps':1136,'pb':280,'pt':776,'pv':816,'pu':1360,
         'qa':840,'qc':904,'qd':856,'qe':512,'qf':1088,'qg':904,'qh':696,'qi':776,'qj':856,'qk':1768,'ql':1264,'qm':2240,'qn':864,'qo':1000,'qp':688,'qr':320,'qs':800,'qb':584,'qt':1616,'qv':912,'qu':1312,
         'ra':352,'rc':392,'rd':592,'re':1728,'rf':808,'rg':768,'rh':480,'ri':864,'rj':1160,'rk':1528,'rl':1256,'rm':1312,'rn':2048,'ro':1424,'rp':960,'rq':456,'rs':1072,'rb':432,'rt':1808,'rv':832,'ru':1392,
         'sa':512,'sc':952,'sd':1112,'se':1296,'sf':1144,'sg':864,'sh':904,'si':936,'sj':648,'sk':1608,'sl':1472,'sm':1344,'sn':824,'so':1256,'sp':1192,'sq':1056,'sr':872,'sb':320,'st':1144,'sv':968,'su':1472,
         'ta':912,'tc':1584,'td':2432,'te':1126,'tf':1312,'tg':1096,'th':992,'ti':1432,'tj':1736,'tk':2576,'tl':1312,'tm':1192,'tn':408,'to':992,'tp':280,'tq':696,'tr':752,'ts':1016,'tb':856,'tv':992,'tu':1192,
         'va':448,'vc':1216,'vd':2048,'ve':544,'vf':1312,'vg':1008,'vh':344,'vi':1176,'vj':1528,'vk':896,'vl':832,'vm':2800,'vn':1472,'vo':1120,'vp':672,'vq':2304,'vr':936,'vs':536,'vb':608,'vt':1664,'vu':2512,
         'ua':368,'uc':1008,'ud':3264,'ue':2760,'uf':952,'ug':1560,'uh':1656,'ui':1432,'uj':1496,'uk':3472,'ul':984,'um':1576,'un':1080,'uo':1728,'up':2048,'uq':1960,'ur':2512,'us':2064,'ub':368,'ut':1048,'uv':1048,
         'ba':1192,'bc':1496,'bd':2136,'be':1336,'bf':1072,'bg':968,'bh':752,'bi':1072,'bj':1256,'bk':3400,'bl':1664,'bm':1272,'bn':1496,'bo':776,'bp':856,'bq':1024,'br':1168,'bs':832,'bt':1744,'bu':1968,'bv':1072,}
    #需求解的OD对以及总人数
    ####所有相邻的两点,这里必须填上所有的相邻点，初始值都是0############
    ALL_TWO = {'ac':0,'cd':0,'de':0,'ef':0,'fg':0,'gh':0,'di':0,'ij':0,'jk':0,'kl':0,'lm':0,'mf':0,'fn':0,'nd':0,'do':0,'op':0,'pq':0,'qr':0,'rs':0,'sj':0,'bt':0,'tn':0,'ne':0,'ev':0,'vk':0,'ku':0,
             'ca':0,'dc':0,'ed':0,'fe':0,'gf':0,'hg':0,'id':0,'ji':0,'kj':0,'lk':0,'ml':0,'fm':0,'nf':0,'dn':0,'od':0,'po':0,'qp':0,'rq':0,'sr':0,'js':0,'tb':0,'nt':0,'en':0,'ve':0,'kv':0,'uk':0}

    
    D_CHANGE_ROUTE = {'4->13':14.5,'4->2':7.5,'13->2':15,'13->4':12.75,'2->4':8.25,'2->13':14.25}#D站点换乘耗时
...
class Ant(object):#蚂蚁类
    ...
    def get_scope(self,square):#获取当前蚂蚁的【范围】
        ...
        scope=[self.world.SQUARES[y][x - 1],self.world.SQUARES[y + 1][x - 1],
                    self.world.SQUARES[y + 1][x],self.world.SQUARES[y + 1][x + 1],
                    self.world.SQUARES[y][x + 1],self.world.SQUARES[y - 1][x + 1],
                    self.world.SQUARES[y - 1][x],self.world.SQUARES[y - 1][x - 1]]
        return scope
    #蚂蚁所具备的本能【前进->觅食或寻窝】
    def go_next_square(self):
        ...
        def change_route_cost():#计算换乘代价
            ...
            if(cur_station == 'd'):
                ...
                elif(prev_station in Settings.ROUTE_LINE_4 and next_station in Settings.ROUTE_LINE_2):
                    change_cost = Settings.D_CHANGE_ROUTE['4->2']
                elif(prev_station in Settings.ROUTE_LINE_13 and next_station in Settings.ROUTE_LINE_2):
                    change_cost = Settings.D_CHANGE_ROUTE['13->2']
                elif(prev_station in Settings.ROUTE_LINE_13 and next_station in Settings.ROUTE_LINE_4):
                    change_cost = Settings.D_CHANGE_ROUTE['13->4']
                elif(prev_station in Settings.ROUTE_LINE_2 and next_station in Settings.ROUTE_LINE_4):
                    change_cost = Settings.D_CHANGE_ROUTE['2->4']
                elif(prev_station in Settings.ROUTE_LINE_2 and next_station in Settings.ROUTE_LINE_13):
                ...
                elif(prev_station in Settings.ROUTE_LINE_2 and next_station in Settings.ROUTE_LINE_1):
                ...
                elif(prev_station in Settings.ROUTE_LINE_4 and next_station in Settings.ROUTE_LINE_1):
        ...
        if(find_food_nest == True):#找到食物或者窝
            ...
            if((self.square.label == 'd' or self.square.label == 'f' or self.square.label == 'j'or self.square.label == 'n'or self.square.label == 'e'or self.square.label == 'k') and self.prev_direction!=-1):
            ...
            self.scope=[self.world.SQUARES[y][x-1],self.world.SQUARES[y+1][x-1],
                        self.world.SQUARES[y+1][x],self.world.SQUARES[y+1][x+1],
                        self.world.SQUARES[y][x+1],self.world.SQUARES[y-1][x+1],
                        self.world.SQUARES[y-1][x],self.world.SQUARES[y-1][x-1]]
        ...
        elif(square == None):#如果觅食规则无效，则执行移动规则(无效即无信息素指引)
            (next_direction,square,route_line) = self.move_rule()#执行移动规则
            if(square == None):#如果移动规则无效(即撞墙)，则执行避障规则
    ...
    def move_rule(self):
        ...
        def search_route_line():#查找上次所在的线路，获得惯性方向
            next_station = None
            route_lines = [Settings.ROUTE_LINE_1,Settings.ROUTE_LINE_2,Settings.ROUTE_LINE_4,Settings.ROUTE_LINE_13]
            next_line = None
        ...
        for i in range(8):#搜索所有连通当前站点且未走过的站点
            if(self.scope[i] == None or self.scope[i] in self.food_route or self.scope[i] in self.nest_route):
                continue
        ...
        if(random.random() <= Settings.PERTURBATION):#扰动规则，符合则进行随机扰动           
            ...
            for i in range(8):
                if(square != None and square not in routes):
                    square = None
    ...
    def find_food_nest_rule(self):
        ...
        def calculate_pheromone(square,behavior):#计算信息素量
            if(behavior == 'FOOD'):
                return square.pheromone.food_pheromone*Settings.PHEROMONE_WEIGHT+square.pheromone.nest_pheromone*(1-Settings.PHEROMONE_WEIGHT)
            if(behavior == 'NEST'):
                return square.pheromone.food_pheromone*(1-Settings.PHEROMONE_WEIGHT)+square.pheromone.nest_pheromone*Settings.PHEROMONE_WEIGHT
        ...
        for i in range(routes_num):
            if(routes[i].square_food.food_type!=None and self.behavior == 'FOOD'):#如果有食物，直接返回，不再考查激素
                return(i,routes[i],self.square.label+routes[i].label,True)
            if(routes[i].square_nest.nest_type!=None and self.behavior == 'NEST'):#如果有蚁巢，直接返回，不再考查激素
                return(i,routes[i],self.square.label+routes[i].label,True)#方向，方格，线路，是否找到
            if((routes[i].pheromone.food_pheromone!=0 and self.behavior == 'FOOD') or (routes[i].pheromone.nest_pheromone!=0 and self.behavior=='NEST')):
                bool_pheromone=True

        if(bool_pheromone == False):#如果没有激素，则返回执行后面的规则
            return(-1,None,'',False)
        else:#有激素，则获取所有可选方向
            pheromone_values = []
            ...
            if(len(pheromone_values) >= 2):#少于2个，不具有选错性
                if(random.random() <= Settings.MISTAKE_RATE):#执行错误选择信息素方向规则，满足则去除最大值，从剩下的随机选取一个移动
                    ...
                    (next_direction,square) = (self.scope.index(routes[next_direction]),routes[next_direction])
                    line = self.square.label+square.label
    ...
    def spread_pheromone_rule(self,x,y):
        ...
        if(self.behavior == 'NEST'):
            self.world.SQUARES[y][x].pheromone.food_pheromone += 1.0*Settings.PHEROMONE/self.total_route_len
        if(self.behavior == 'FOOD'):
            self.world.SQUARES[y][x].pheromone.nest_pheromone += 1.0*Settings.PHEROMONE/self.total_route_len
...
class Pheromone(object):#激素类
    ...
    def set_nest_pheromone(self,food_pheromone):
        self.nest_pheromone = nest_pheromone
############扩展类结束################
...
class World(object):#世界类
    ...
    def update_pheromone(self):#更新信息素规则(环境挥发)
        ...
        for y in range(len(self.SQUARES)):
            for x in range(len(self.SQUARES[0])):
                if(self.SQUARES[y][x] != None):
                    self.SQUARES[y][x].pheromone.food_pheromone = (1-Settings.RHO)*self.SQUARES[y][x].pheromone.food_pheromone
                    self.SQUARES[y][x].pheromone.nest_pheromone = (1-Settings.RHO)*self.SQUARES[y][x].pheromone.nest_pheromone
    ...
    for od in Settings.O_D.keys():
        ...
        if(len(best_route) == 0):
            ...
            for k_path in range(len(k_paths)):
                if(k_paths[k_path][1] - shortest_len>10):
                    ...
                    print('The '+str(k_path+1)+' K-path for OD: '+od+'->'+'-'.join(k_paths[k_path][0])+' time:'+str(k_paths[k_path][1])+' min')
        ...
        if(len(k_path_od) == 1):
            ...
            for i in range(len(k_path_od[0][0][0])-1):
                Settings.ALL_TWO[k_path_od[0][0][0][i]+k_path_od[0][0][0][i+1]]+=Settings.O_D[od]
        else:
            for k_path in range(len(k_path_od)):
                ...
                for i in range(len(k_path_od[k_path][0][0])-1):
                    Settings.ALL_TWO[k_path_od[k_path][0][0][i]+k_path_od[k_path][0][0][i+1]]+=Settings.O_D[od]*Pk(k_two)
